...
export function FilterPanelDesktop({
  ...
  return (
    <div className="hidden lg:block">
      <Card className="border border-slate-200/70 bg-white/90 shadow-sm shadow-slate-900/10 dark:border-slate-700/80 dark:bg-slate-950/90 dark:shadow-slate-950/20">
        <FilterPanelContent
