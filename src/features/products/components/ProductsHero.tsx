...
export function ProductsHero({ badge, heading, description }: ProductsHeroProps) {
  return (
    <header className="relative mb-5 overflow-hidden rounded-[2rem] border border-gray-200 bg-white px-4 py-6 shadow-2xl ring-1 shadow-gray-200/20 ring-gray-300/20 backdrop-blur-xl sm:px-10 dark:border-white/10 dark:bg-slate-950/85 dark:shadow-cyan-500/10 dark:ring-cyan-400/10">
