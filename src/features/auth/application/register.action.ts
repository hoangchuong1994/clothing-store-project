...
import type { RegisterSchema as RegisterSchemaType } from '../domain/validation/auth-schemas';
import AuthService from './auth.service';
import { AuthError, DuplicateEmailError, getSafeErrorMessage, isAuthError } from '../domain/errors';
